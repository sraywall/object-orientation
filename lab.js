...
//Code Here
let myFirstVehicle = new Vehicle(5,"blue",300000);
...
//Code Here 
let myFirstMotorcycle = new Motorcycle(2,"red",30000);
/*
...
//Code Here
let titanic = new Boat(1000,"black",10,"Titanic","ship",false);
/*
  Call the checkSeaworthiness method on your new boat
*/

//Code Here
console.log(`${titanic.name} isSeaworthy: ${titanic.isSeaworthy}`);
/*
  Now run the performMaintenance method on your boat
*/
//Code Here 
titanic.performMaintenance();
